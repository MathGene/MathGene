...
var mgCalc = (function() {
    ...
    function cDivS(xU,xL) { //divide xU/xL
        ...
        if (xU == "Cv[8734]") {if (+xL < 0) {return "cNeg(Cv[8734])"};return "Cv[8734]"}
    ...
    function cAddS(xU,xL) { //add xU+xL
        ...
        if (!factorFlag && !limitFlag && xTractU.func == "cDiv" && xTractL.func == "cDiv" && !nbrTest(xTractU.lower) && !nbrTest(xTractL.lower)){ //add fractions
    ...
    function cSubS(xU,xL) { //subtract xU-xL
        ...
        if (!factorFlag && !limitFlag && !pxpFlag && xTractU.func == "cDiv" && xTractL.func == "cDiv" && !nbrTest(xTractU.lower) && !nbrTest(xTractL.lower)){ //subtract fractions
            var lTemp = cDivS(xTractU.lower,xTractL.lower);
            var uTemp = cDivS(xTractL.lower,xTractU.lower);
    ...
    function ntgS(nXpr,deeVar,iU,iL) { //integrate (integrand, variable, upper_limit, lower_limit)
        ...
        function cMulI(xU,xL) {
            ...
            if (xTractU.func == "cMul" && !strTest(xTractU.upper,deeVar)) {return cMulS(xTractU.upper,cMulI(xTractU.lower,xL))}
            if (xTractU.func == "cMul" && !strTest(xTractU.lower,deeVar)) {return cMulS(xTractU.lower,cMulI(xTractU.upper,xL))}
            if (xTractL.func == "cMul" && !strTest(xTractL.upper,deeVar)) {return cMulS(xTractL.upper,cMulI(xTractL.lower,xU))}
            if (xTractL.func == "cMul" && !strTest(xTractL.lower,deeVar)) {return cMulS(xTractL.lower,cMulI(xTractL.upper,xU))}
            //special cases
    ...
    function xprTrigToExp(xU) { //convert trig to exponential forms
        ...
        return xReduce(eval(xU.replace(/(Cv\[\d+\])/g,"'$1'").replace(/(Pv\[\d+\])/g,"'$1'").replace(/(Sv\[\d+\])/g,"'$1'")))
    }
    ...
    function lmtS(lXpr,lVar,xLim) {
        ...
        function cMulL(xU,xL) {
            ...
            if (strTest(lmtS(xU,lVar,xLim),"Cv[8734]") && lmtS(xL,lVar,xLim) == 0) {return cDivL(xL,cPowS(xU,-1))}
            if (lmtS(xU,lVar,xLim) == 0 && strTest(lmtS(xL,lVar,xLim),"Cv[8734]")) {return cDivL(xU,cPowS(xL,-1))}
        ...
        function cPowL(xU,xL) {
            ...
            if (lmtS(xU,lVar,xLim) == 0 && lmtS(xL,lVar,xLim) == 0) {return cPowS("Cv[8]",cMulL(xL,lneS(xU)))} //power rule
            if (strTest(lmtS(xU,lVar,xLim),"Cv[8734]") && lmtS(xL,lVar,xLim) == 0) {return cPowS("Cv[8]",cMulL(xL,lneS(xU)))} //power rule
            if (lmtS(xU,lVar,xLim) == 1 && strTest(lmtS(xL,lVar,xLim),"Cv[8734]")) {return cPowS("Cv[8]",cMulL(xL,lneS(xU)))} //power rule
            return cPowS(xU,xL)
        }
        function lneL(xU) {return lneS(lmtS(xU,lVar,xLim))}
        function sqtL(xU) {return sqtS(lmtS(xU,lVar,xLim))}
        function cbtL(xU) {return cbtS(lmtS(xU,lVar,xLim))}
        function sinL(xU) {return sinS(lmtS(xU,lVar,xLim))}
        function cosL(xU) {return cosS(lmtS(xU,lVar,xLim))}
        function tanL(xU) {return tanS(lmtS(xU,lVar,xLim))}
        function cscL(xU) {return lmtS(cDivS(1,sinS(xU)),lVar,xLim)}
        function secL(xU) {return lmtS(cDivS(1,cosS(xU)),lVar,xLim)}
        function cotL(xU) {return cotS(lmtS(xU,lVar,xLim))}
        function snhL(xU) {return snhS(lmtS(xU,lVar,xLim))}
        function cshL(xU) {return cshS(lmtS(xU,lVar,xLim))}
        function tnhL(xU) {return tnhS(lmtS(xU,lVar,xLim))}
        function schL(xU) {return schS(lmtS(xU,lVar,xLim))}
        function cchL(xU) {return cchS(lmtS(xU,lVar,xLim))}
        ...
        function ashL(xU) {return ashS(lmtS(xU,lVar,xLim))}
        function achL(xU) {return achS(lmtS(xU,lVar,xLim))}
        function athL(xU) {return athS(lmtS(xU,lVar,xLim))}
        function axhL(xU) {return axhS(lmtS(xU,lVar,xLim))}
        function ayhL(xU) {return ayhS(lmtS(xU,lVar,xLim))}
        function azhL(xU) {return azhS(lmtS(xU,lVar,xLim))}
        function expL(xU) {return expS(lmtS(xU,lVar,xLim))}
        function absL(xU) {return absS(lmtS(xU,lVar,xLim))}
        function erfL(xU) {return erfS(lmtS(xU,lVar,xLim))}
        function efcL(xU) {return efcS(lmtS(xU,lVar,xLim))}
    ...
    function cPow(xU,xL) { //powers xU^xL
        ...
        cTmp.r = rou(cTmp.r*dRound)/dRound;
        cTmp.i = rou(cTmp.i*dRound)/dRound;
        return cTmp;
    }
    ...
    function arg(xU) { //arg(x)
        if (getType(xU) == "complex" || getType(xU) == "real" ) {
            ...
            if (cA.r < 0 && cA.i >= 0) {return Cv[29]+Math.atan(cA.i/cA.r)}
            if (cA.r < 0 && cA.i < 0) {return -Cv[29]+Math.atan(cA.i/cA.r)}
            if (cA.r == 0 && cA.i > 0) {return Cv[29]/2}
            if (cA.r == 0 && cA.i < 0) {return -Cv[29]/2}
            return 0
        }
        return "undefined"
    ...
    function exp(xU) { //exp(x)
        if (getType(xU) == "complex" && xU.i != 0) {
            var cA = toCplx(xU);
            return {r:cMul(Math.exp(cA.r),Math.cos(cA.i)), i:cMul(Math.exp(cA.r),Math.sin(cA.i))}
        }
    ...
    //trig functions
    function  trigRound(xU) {return cDiv(rou(cMul(cMul(xU,mgConfig.trigBase),dRound)),dRound)}
    ...
    function aTrigRound(xU) {return cDiv(rou(cMul(cDiv(xU,mgConfig.trigBase),dRound)),dRound)}
    function asn(xU) {//asin
        ...
        if (getType(xU) == "real") {return aTrigRound(Math.asin(toReal(xU)))}
        return "undefined"
    }
    function acs(xU) {//acos
        ...
        if (getType(xU) == "real") {return aTrigRound(Math.acos(toReal(xU)))}
        return "undefined"
    }
    ...
    function csh(xU) {//cosh
        ...
        if (getType(xU) == "real") {return hypRound(cDiv(cAdd(exp(xU),exp(cNeg(xU))),2))}
        return "undefined"
    }
    ...
    function sch(xU) {//sech
        ...
        if (getType(xU) == "real") {return hypRound(cDiv(2,cAdd(exp(xU),exp(cNeg(xU)))))}
        return "undefined"
    }
    function cch(xU) {//csch
        if (getType(xU) == "complex") {return cDiv(1,snh(xU))}
        if (getType(xU) == "real") {return hypRound(cDiv(2,cSub(exp(xU),exp(cNeg(xU)))))}
        return "undefined"
    }
    ...
    function normPDF(sigma,xV,mu) { //probability density function
        ...
        return (1/(sigma*2.5066282)*exp(-(Math.pow(xV-mu,2)/(2*Math.pow(sigma,2)))));
    }
    ...
    function lognPDF(sigma,xV,mu) { //log probability density function
        sigma = toReal(sigma);xV = toReal(xV);mu = toReal(mu);
        return (1/(xV*sigma*2.5066282)*exp(-(Math.pow(lne(xV)-mu,2)/(2*Math.pow(sigma,2)))));
    }
    ...
    function finOPTgamma(fT,fR,fK,fS,fQ,sDv) {
        fT = toReal(fT);fR = toReal(fR);fK = toReal(fK);fS = toReal(fS);fQ = toReal(fQ);sDv = toReal(sDv);
        return roundDecTo((normPDF(1,finD1(fT,fR,fK,fS,fQ,sDv),0)*exp(-fQ*fT))/(fS*sDv*Math.sqrt(fT)),mgConfig.dPrecision);
    }
    function finCALLtheta(fT,fR,fK,fS,fQ,sDv) {
        fT = toReal(fT);fR = toReal(fR);fK = toReal(fK);fS = toReal(fS);fQ = toReal(fQ);sDv = toReal(sDv);
        return roundDecTo((-exp(-(fQ/mgConfig.pctFactor)*fT)*(normPDF(1,finD1(fT,fR,fK,fS,fQ,sDv),0)*fS*sDv)/(2*Math.sqrt(fT))-(fR/mgConfig.pctFactor)*fK*exp(-(fR/mgConfig.pctFactor)*fT)*normCDF(1,finD2(fT,fR,fK,fS,fQ,sDv),0)+(fQ/mgConfig.pctFactor)*fS*exp(-(fQ/mgConfig.pctFactor)*fT)*normCDF(1,finD1(fT,fR,fK,fS,fQ,sDv),0))/365,mgConfig.dPrecision);
    }
    ...
    function finOPTvega(fT,fR,fK,fS,fQ,sDv) {
        fT = toReal(fT);fR = toReal(fR);fK = toReal(fK);fS = toReal(fS);fQ = toReal(fQ);sDv = toReal(sDv);
        return roundDecTo(normPDF(1,finD1(fT,fR,fK,fS,fQ,sDv),0)*fS*exp(-(fQ/mgConfig.pctFactor)*fT)*Math.sqrt(fT)/100,mgConfig.dPrecision);
    }
