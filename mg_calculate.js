...
var mgCalc = function() {
    ...
    function execFunc(expIn,funcObj) { //execute math expression
        ...
        for (nXf=0;nXf<sCount;nXf++) {
			...
			if (typeof funcObj[funcKey] == "undefined") {fReturn = passthruFunc[funcKey](paramS[0],paramS[1],paramS[2],paramS[3])} //execute passthru
            else {fReturn = funcObj[funcKey](paramS[0],paramS[1],paramS[2],paramS[3])}//execute operation
