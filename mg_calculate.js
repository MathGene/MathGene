...
var mgCalc = (function() {
    ...
    function iReduce(iRdce) { //reduce by iterative expansion
        ...
        for (var iC in iInv) {if (nbrTest(iInv[iC]) || !iInv[iC] || !varTest(iInv[iC])) {iCount[iC] = 0} else {iCount[iC] = iRdce.split(iInv[iC]).length-1};if (iCount[iC] > 1) {xFlag = false}}
    ...
    function smxS(xU) { //consolidate sum-difference terms 2a-b+c/d -> [(2a),(-b),(c/d)]
        ...
        for (var xI in Sv) {for (var yI in Sv) {if (xI != yI && Sv[xI] == Sv[yI]) {var rgx = new RegExp("Sv\\["+yI+"\\]","g");Sv[xU] = Sv[xU].replace(rgx,"Sv["+xI+"]")}}} //consolidate identical pointers
    ...
    function pxpS(xU) { //consolidate product-quotient-exponent terms 2ab/(cd) -> [(2),(a),(b),(c^-1),(d^-1)]
        ...
        for (var xI in Pv) {for (var yI in Pv) {if (xI != yI && Pv[xI] == Pv[yI]) {var rgx = new RegExp("Pv\\["+yI+"\\]","g");Pv[xU] = Pv[xU].replace(rgx,"Pv["+xI+"]")}}} //consolidate identical pointers
    ...
    function vSubS(xU,xL) { //parse cSub into Sv
        if (SvTest(xU) && !SvTest(xL)) {Sv[Sv.length-1] = Sv[Sv.length-1]+"_"+cNegS(xL)}
            ...
            for (var tD in tDif) {Sv[Sv.length-1] = Sv[Sv.length-1]+"_"+cNegS(tDif[tD])}
        }
    ...
    function aGcf(xG){ //find GCF of integer array
        ...
        for (var xI in xG) {tGcf[xI]= xG[xI]}
    ...
    function cMulS(xU,xL) { //multiply xU * xL
    ...
    function cTmsS(xU,xL) {return cMulS(xU,xL)} //multiply xU * xL as terms
    ...
    function sinS(xU) {
        ...
        if (+xU == 0) {return 0}
        if (nbrTest(xU) && sin(xU) == int(sin(xU))) {return cFunc(fmtResult(sin(xU)))}
        return "sin("+xU+")"
    }
    var cosAngle = [
    ...
    function cosS(xU) {
        ...
        if (+xU == 0) {return 1}
        if (nbrTest(xU) && cos(xU) == int(cos(xU))) {return cFunc(fmtResult(cos(xU)))} 
        return "cos("+xU+")"
    }
    var tanAngle = [
    ...
    function tanS(xU) {
        ...
        if (+xU == 0) {return 0}
        if (nbrTest(xU) && tan(xU) == int(tan(xU))) {return cFunc(fmtResult(tan(xU)))}
        return "tan("+xU+")"
    }
    var secAngle = [
    ...
    function secS(xU) {
        ...
        if (+xU == 0) {return 1}
        if (nbrTest(xU) && sec(xU) == int(sec(xU))) {return cFunc(fmtResult(sec(xU)))}
        return "sec("+xU+")"
    }
    var cscAngle = [
    ...
    function cscS(xU) {
        ...
        if (nbrTest(xU) && csc(xU) == int(csc(xU))) {return cFunc(fmtResult(csc(xU)))}
        return "csc("+xU+")"
    }
    var cotAngle = [
    ...
    function cotS(xU) {
        ...
        if (+xU == 0) {return "undefined"}
        if (nbrTest(xU) && cot(xU) == int(cot(xU))) {return cFunc(fmtResult(cot(xU)))}
        return "cot("+xU+")"
    }
    function asnS(xU) {
        var xTractU = opExtract(xU);
        ...
        if (nbrTest(xU) && asn(xU) == int(asn(xU))) {return cFunc(fmtResult(asn(xU)))}
    ...
    function acsS(xU) {
        ...
        if (nbrTest(xU) && acs(xU) == int(acs(xU))) {return cFunc(fmtResult(acs(xU)))}
    ...
    function atnS(xU) {
        ...
        if (nbrTest(xU) && atn(xU) == int(atn(xU))) {return cFunc(fmtResult(atn(xU)))}
    ...
    function ascS(xU) {
        ...
        if (nbrTest(xU) && asc(xU) == int(asc(xU))) {return cFunc(fmtResult(asc(xU)))}
    ...
    function accS(xU) {
        ...
        if (nbrTest(xU) && acc(xU) == int(acc(xU))) {return cFunc(fmtResult(acc(xU)))}
    ...
    function actS(xU) {
        ...
        if (nbrTest(xU) && act(xU) == int(act(xU))) {return cFunc(fmtResult(act(xU)))}
    ...
    function snhS(xU) {
        var xTractU = opExtract(xU);
        if (nbrTest(xU) && snh(xU) == int(snh(xU))) {return cFunc(fmtResult(snh(xU)))}
    ...
    function cshS(xU) {
        var xTractU = opExtract(xU);
        if (nbrTest(xU) && csh(xU) == int(csh(xU))) {return cFunc(fmtResult(csh(xU)))}
    ...
    function tnhS(xU) {
        var xTractU = opExtract(xU);
        if (nbrTest(xU) && tnh(xU) == int(tnh(xU))) {return cFunc(fmtResult(tnh(xU)))}
    ...
    function schS(xU) {
        var xTractU = opExtract(xU);
        if (nbrTest(xU) && sch(xU) == int(sch(xU))) {return cFunc(fmtResult(sch(xU)))}
    ...
    function cchS(xU) {
        var xTractU = opExtract(xU);
        if (nbrTest(xU) && cch(xU) == int(cch(xU))) {return cFunc(fmtResult(cch(xU)))}
    ...
    function cthS(xU) {
        var xTractU = opExtract(xU);
        if (nbrTest(xU) && cth(xU) == int(cth(xU))) {return cFunc(fmtResult(cth(xU)))}
    ...
    function ashS(xU) {
        var xTractU = opExtract(xU);
        if (nbrTest(xU) && ash(xU) == int(ash(xU))) {return cFunc(fmtResult(ash(xU)))}
        if (xTractU.func == "snh") {return xTractU.upper}
        return "ash("+xU+")"
    }
    function achS(xU) {
        var xTractU = opExtract(xU);
        if (nbrTest(xU) && ach(xU) == int(ach(xU))) {return cFunc(fmtResult(ach(xU)))}
        if (xTractU.func == "csh") {return xTractU.upper}
        return "ach("+xU+")"
    }
    function athS(xU) {
        var xTractU = opExtract(xU);
        if (nbrTest(xU) && ath(xU) == int(ath(xU))) {return cFunc(fmtResult(ath(xU)))}
    ...
    function axhS(xU) {
        var xTractU = opExtract(xU);
        if (nbrTest(xU) && axh(xU) == int(axh(xU))) {return cFunc(fmtResult(axh(xU)))}
        if (xTractU.func == "sch") {return xTractU.upper}
        return "axh("+xU+")"
    }
    function ayhS(xU) {
        var xTractU = opExtract(xU);
        if (nbrTest(xU) && ayh(xU) == int(ayh(xU))) {return cFunc(fmtResult(ayh(xU)))}
        if (xTractU.func == "cch") {return xTractU.upper}
        return "ayh("+xU+")"
    }
    function azhS(xU) {
        var xTractU = opExtract(xU);
        if (nbrTest(xU) && azh(xU) == int(azh(xU))) {return cFunc(fmtResult(azh(xU)))}
    ...
    function sdrS(xU,xL,xN) {
        if (typeof xN == "undefined") {return "tdv("+xU+","+xL+")"}
        return "tdv("+xU+","+xL+","+xN+")"
    }
    function psdS(xU,xL,xN) {
    ...
    function xprRange(xR)  {
        function nEqual(nZ,nC) {
            ...
            for (var iZ in zVars) {zArray[iZ] = mgExport(xprSolve(cFunc(nZ+"Cv[8800]"+nC),"Cv["+zVars[iZ]+"]"))}
            for (var iZ in zVars) {
    ...
    function xprDomain(xD)  { 
        ...
        for (var iV in allVars) {allVars[iV] = "Cv["+allVars[iV]+"]"}
        var realVars = [];
        var integerVars = [];
        ...
        var dString = "";
        for (var iV in allVars) { //collect master domain vars
    ...
    function pmmS(pXpr,pUpper,dV,pLower) {
        ...
        pIterations++;
        if (strTest(pLower,"Cv[8734]") || strTest(pUpper,"Cv[8734]")) {return "pmm("+xReduce(pXpr)+","+pUpper+","+dV+","+pLower+")"}
