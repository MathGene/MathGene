...
var funcMap =
{
sin:{   htmlL1:"'<Xfnc>sin<Xfnx>('+mA",
        htmlR1:"')'",
        htmlL2:"'<Xfnc>sin<Xfxp> '+mA",
        htmlR2:"' '",
        trig:true,
        invfunc:"asn",
        texfunc:"\\sin",
...
cos:{   htmlL1:"'<Xfnc>cos<Xfnx>('+mA",
        htmlR1:"')'",
        htmlL2:"'<Xfnc>cos<Xfxp> '+mA",
        htmlR2:"' '",
        trig:true,
        invfunc:"acs",
        texfunc:"\\cos",
...
tan:{   htmlL1:"'<Xfnc>tan<Xfnx>('+mA",
        htmlR1:"')'",
        htmlL2:"'<Xfnc>tan<Xfxp> '+mA",
        htmlR2:"' '",
        trig:true,
        invfunc:"atn",
        texfunc:"\\tan",
...
sec:{   htmlL1:"'<Xfnc>sec<Xfnx>('+mA",
        htmlR1:"')'",
        htmlL2:"'<Xfnc>sec<Xfxp> '+mA",
        htmlR2:"' '",
        trig:true,
        invfunc:"asc",
        texfunc:"\\sec",
...
csc:{   htmlL1:"'<Xfnc>csc<Xfnx>('+mA",
        htmlR1:"')'",
        htmlL2:"'<Xfnc>csc<Xfxp> '+mA",
        htmlR2:"' '",
        trig:true,
        invfunc:"acc",
        texfunc:"\\csc",
...
cot:{   htmlL1:"'<Xfnc>cot<Xfnx>('+mA",
        htmlR1:"')'",
        htmlL2:"'<Xfnc>cot<Xfxp> '+mA",
        htmlR2:"' '",
        trig:true,
        invfunc:"act",
        texfunc:"\\cot",
...
snh:{   htmlL1:"'<Xfnc>sinh<Xfnx>('+mA",
        htmlR1:"')'",
        htmlL2:"'<Xfnc>sinh<Xfxp> '+mA",
        htmlR2:"' '",
        trig:true,
        invfunc:"ash",
        texfunc:"\\sinh",
        latexL1:"'\\\\sinh(<Xfnx>'+mA",
        latexR1:"')'",
        latexL2:"'\\\\sinh<Xfxp> {'+mA",
        latexR2:"'}'",
        mg: "'snh('+mA+')'",
        },
csh:{   htmlL1:"'<Xfnc>cosh<Xfnx>('+mA",
        htmlR1:"')'",
        htmlL2:"'<Xfnc>cosh<Xfxp> '+mA",
        htmlR2:"' '",
        trig:true,
        invfunc:"ach",
        texfunc:"\\cosh",
        latexL1:"'\\\\cosh(<Xfnx>'+mA",
        latexR1:"')'",
        latexL2:"'\\\\cosh<Xfxp> {'+mA",
        latexR2:"'}'",
        mg: "'csh('+mA+')'",
        },
"tnh":{ htmlL1:"'<Xfnc>tanh<Xfnx>('+mA",
        htmlR1:"')'",
        htmlL2:"'<Xfnc>tanh<Xfxp> '+mA",
        htmlR2:"' '",
        trig:true,
        invfunc:"ath",
        texfunc:"\\tanh",
...
sch:{   htmlL1:"'<Xfnc>sech<Xfnx>('+mA",
        htmlR1:"')'",
        htmlL2:"'<Xfnc>sech<Xfxp> '+mA",
        htmlR2:"' '",
        trig:true,
        invfunc:"axh",
        texfunc:"\\sech",
        latexL1:"'\\\\sech(<Xfnx>'+mA",
        latexR1:"')'",
        latexL2:"'\\\\sech<Xfxp> {'+mA",
        latexR2:"'}'",
        mg: "'sch('+mA+')'",
        },
cch:{   htmlL1:"'<Xfnc>csch<Xfnx>('+mA",
        htmlR1:"')'",
        htmlL2:"'<Xfnc>csch<Xfxp> '+mA",
        htmlR2:"' '",
        trig:true,
        invfunc:"ayh",
        texfunc:"\\csch",
        latexL1:"'\\\\csch(<Xfnx>'+mA",
        latexR1:"')'",
        latexL2:"'\\\\csch<Xfxp> {'+mA",
        latexR2:"'}'",
        mg: "'cch('+mA+')'",
        },
cth:{   htmlL1:"'<Xfnc>coth<Xfnx>('+mA",
        htmlR1:"')'",
        htmlL2:"'<Xfnc>coth<Xfxp> '+mA",
        htmlR2:"' '",
        trig:true,
        invfunc:"azh",
        texfunc:"\\coth",
        latexL1:"'\\\\coth(<Xfnx>'+mA",
        latexR1:"')'",
        latexL2:"'\\\\coth<Xfxp> {'+mA",
        latexR2:"'}'",
        mg: "'cth('+mA+')'",
        },
asn:{   htmlL1:"'<Xfnc>asin<Xfnx>('+mA",
        htmlR1:"')'",
        htmlL2:"'<Xfnc>asin '+mA",
        htmlR2:"' <Xfxp>'",
        htmlInv1:"'<Xfnc>sin<sup>-1</sup><Xfnx>('+mA",
        htmlInv2:"'<Xfnc>sin<sup>-1</sup> <Xfnx>'+mA",
        texfunc:"\\arcsin",
        latexL1:"'\\\\arcsin(<Xfnx>'+mA",
        latexR1:"')'",
        latexL2:"'\\\\arcsin {'+mA",
        latexR2:"'}'",
        latexInv1:"'\\\\sin^{-1}(<Xfnx>'+mA",
        latexInv2:"'\\\\sin^{-1} {'+mA",
        mg: "'asn('+mA+')'",
        },
acs:{   htmlL1:"'<Xfnc>acos<Xfnx>('+mA",
        htmlR1:"')'",
        htmlL2:"'<Xfnc>acos '+mA",
        htmlR2:"' <Xfxp>'",
        htmlInv1:"'<Xfnc>cos<sup>-1</sup><Xfnx>('+mA",
        htmlInv2:"'<Xfnc>cos<sup>-1</sup> <Xfnx>'+mA",
        texfunc:"\\arccos",
        latexL1:"'\\\\arccos(<Xfnx>'+mA",
        latexR1:"')'",
        latexL2:"'\\\\arccos {'+mA",
        latexR2:"'}'",
        latexInv1:"'\\\\cos^{-1}(<Xfnx>'+mA",
        latexInv2:"'\\\\cos^{-1} {'+mA",
        mg: "'acs('+mA+')'",
        },
atn:{   htmlL1:"'<Xfnc>atan<Xfnx>('+mA",
        htmlR1:"')'",
        htmlL2:"'<Xfnc>atan '+mA",
        htmlR2:"' <Xfxp>'",
        htmlInv1:"'<Xfnc>tan<sup>-1</sup><Xfnx>('+mA",
        htmlInv2:"'<Xfnc>tan<sup>-1</sup> <Xfnx>'+mA",
        texfunc:"\\arctan",
        latexL1:"'\\\\arctan(<Xfnx>'+mA",
        latexR1:"')'",
        latexL2:"'\\\\arctan {'+mA",
        latexR2:"'}'",
        latexInv1:"'\\\\tan^{-1}(<Xfnx>'+mA",
        latexInv2:"'\\\\tan^{-1} {'+mA",
        mg: "'atn('+mA+')'",
        },
asc:{   htmlL1:"'<Xfnc>asec<Xfnx>('+mA",
        htmlR1:"')'",
        htmlL2:"'<Xfnc>asec '+mA",
        htmlR2:"' <Xfxp>'",
        htmlInv1:"'<Xfnc>sec<sup>-1</sup><Xfnx>('+mA",
        htmlInv2:"'<Xfnc>sec<sup>-1</sup> <Xfnx>'+mA",
        texfunc:"\\arcsec",
        latexL1:"'\\\\arcsec(<Xfnx>'+mA",
        latexR1:"')'",
        latexL2:"'\\\\arcsec {'+mA",
        latexR2:"'}'",
        latexInv1:"'\\\\sec^{-1}(<Xfnx>'+mA",
        latexInv2:"'\\\\sec^{-1} {'+mA",
        mg: "'asc('+mA+')'",
        },
acc:{   htmlL1:"'<Xfnc>acsc<Xfnx>('+mA",
        htmlR1:"')'",
        htmlL2:"'<Xfnc>acsc '+mA",
        htmlR2:"' <Xfxp>'",
        htmlInv1:"'<Xfnc>csc<sup>-1</sup><Xfnx>('+mA",
        htmlInv2:"'<Xfnc>csc<sup>-1</sup> <Xfnx>'+mA",
        texfunc:"\\arccsc",
        latexL1:"'\\\\arccsc(<Xfnx>'+mA",
        latexR1:"')'",
        latexL2:"'\\\\arccsc {'+mA",
        latexR2:"'}'",
        latexInv1:"'\\\\csc^{-1}(<Xfnx>'+mA",
        latexInv2:"'\\\\csc^{-1} {'+mA",
        mg: "'acc('+mA+')'",
        },
act:{   htmlL1:"'<Xfnc>acot<Xfnx>('+mA",
        htmlR1:"')'",
        htmlL2:"'<Xfnc>acot '+mA",
        htmlR2:"' <Xfxp>'",
        htmlInv1:"'<Xfnc>cot<sup>-1</sup><Xfnx>('+mA",
        htmlInv2:"'<Xfnc>cot<sup>-1</sup> <Xfnx>'+mA",
        texfunc:"\\arccot",
        latexL1:"'\\\\arccot(<Xfnx>'+mA",
        latexR1:"')'",
        latexL2:"'\\\\arccot {'+mA",
        latexR2:"'}'",
        latexInv1:"'\\\\cot^{-1}(<Xfnx>'+mA",
        latexInv2:"'\\\\cot^{-1} {'+mA",
        mg: "'act('+mA+')'",
        },
ash:{   htmlL1:"'<Xfnc>asinh<Xfnx>('+mA",
        htmlR1:"')'",
        htmlL2:"'<Xfnc>asinh '+mA",
        htmlR2:"' <Xfxp>'",
        htmlInv1:"'<Xfnc>sinh<sup>-1</sup><Xfnx>('+mA",
        htmlInv2:"'<Xfnc>sinh<sup>-1</sup> <Xfnx>'+mA",
        texfunc:"\\arcsinh",
        latexL1:"'\\\\arcsinh(<Xfnx>'+mA",
        latexR1:"')'",
        latexL2:"'\\\\arcsinh {'+mA",
        latexR2:"'}'",
        latexInv1:"'\\\\sinh^{-1}(<Xfnx>'+mA",
        latexInv2:"'\\\\sinh^{-1} {'+mA",
        mg: "'ash('+mA+')'",
        },
ach:{   htmlL1:"'<Xfnc>acosh<Xfnx>('+mA",
        htmlR1:"')'",
        htmlL2:"'<Xfnc>acosh '+mA",
        htmlR2:"' <Xfxp>'",
        htmlInv1:"'<Xfnc>cosh<sup>-1</sup><Xfnx>('+mA",
        htmlInv2:"'<Xfnc>cosh<sup>-1</sup> <Xfnx>'+mA",
        texfunc:"\\arccosh",
        latexL1:"'\\\\arccosh(<Xfnx>'+mA",
        latexR1:"')'",
        latexL2:"'\\\\arccosh {'+mA",
        latexR2:"'}'",
        latexInv1:"'\\\\cosh^{-1}(<Xfnx>'+mA",
        latexInv2:"'\\\\cosh^{-1} {'+mA",
        mg: "'ach('+mA+')'",
        },
ath:{   htmlL1:"'<Xfnc>atanh<Xfnx>('+mA",
        htmlR1:"')'",
        htmlL2:"'<Xfnc>atanh '+mA",
        htmlR2:"' <Xfxp>'",
        htmlInv1:"'<Xfnc>tanh<sup>-1</sup><Xfnx>('+mA",
        htmlInv2:"'<Xfnc>tanh<sup>-1</sup> <Xfnx>'+mA",
        texfunc:"\\arctanh",
        latexL1:"'\\\\arctanh(<Xfnx>'+mA",
        latexR1:"')'",
        latexL2:"'\\\\arctanh {'+mA",
        latexR2:"'}'",
        latexInv1:"'\\\\tanh^{-1}(<Xfnx>'+mA",
        latexInv2:"'\\\\tanh^{-1} {'+mA",
        mg: "'ath('+mA+')'",
        },
axh:{   htmlL1:"'<Xfnc>asech<Xfnx>('+mA",
        htmlR1:"')'",
        htmlL2:"'<Xfnc>asech '+mA",
        htmlR2:"' <Xfxp>'",
        htmlInv1:"'<Xfnc>sech<sup>-1</sup><Xfnx>('+mA",
        htmlInv2:"'<Xfnc>sech<sup>-1</sup> <Xfnx>'+mA",
        texfunc:"\\arcsech",
        latexL1:"'\\\\arcsech(<Xfnx>'+mA",
        latexR1:"')'",
        latexL2:"'\\\\arcsech {'+mA",
        latexR2:"'}'",
        latexInv1:"'\\\\sech^{-1}(<Xfnx>'+mA",
        latexInv2:"'\\\\sech^{-1} {'+mA",
        mg: "'axh('+mA+')'",
        },
ayh:{   htmlL1:"'<Xfnc>acsch<Xfnx>('+mA",
        htmlR1:"')'",
        htmlL2:"'<Xfnc>acsch '+mA",
        htmlR2:"' <Xfxp>'",
        htmlInv1:"'<Xfnc>csch<sup>-1</sup><Xfnx>('+mA",
        htmlInv2:"'<Xfnc>csch<sup>-1</sup> <Xfnx>'+mA",
        texfunc:"\\arccsch",
        latexL1:"'\\\\arccsch(<Xfnx>'+mA",
        latexR1:"')'",
        latexL2:"'\\\\arccsch {'+mA",
        latexR2:"'}'",
        latexInv1:"'\\\\csch^{-1}(<Xfnx>'+mA",
        latexInv2:"'\\\\csch^{-1} {'+mA",
        mg: "'ayh('+mA+')'",
        },
azh:{   htmlL1:"'<Xfnc>acoth<Xfnx>('+mA",
        htmlR1:"')'",
        htmlL2:"'<Xfnc>acoth '+mA",
        htmlR2:"' <Xfxp>'",
        htmlInv1:"'<Xfnc>coth<sup>-1</sup><Xfnx>('+mA",
        htmlInv2:"'<Xfnc>coth<sup>-1</sup> <Xfnx>'+mA",
        texfunc:"\\arccoth",
        latexL1:"'\\\\arccoth(<Xfnx>'+mA",
        latexR1:"')'",
        latexL2:"'\\\\arccoth {'+mA",
        latexR2:"'}'",
        latexInv1:"'\\\\coth^{-1}(<Xfnx>'+mA",
        latexInv2:"'\\\\coth^{-1} {'+mA",
        mg: "'azh('+mA+')'",
        },
sqt:{   htmlL1:"radL(0,strg)+mA", //square root
        htmlR1:"radR()",
        htmlL2:"radL(0,strg)+mA",
        htmlR2:"radR()",
        texfunc:"\\sqrt",
        latexL1:"'\\\\sqrt{'+mA",
        latexR1:"'}'",
...
cbt:{   htmlL1:"radL(1,strg)+mA",   //cube root
        htmlR1:"radR()",
        htmlL2:"radL(1,strg)+mA",
        htmlR2:"radR()",
        texfunc:"\\sqrt[3]",
        latexL1:"'\\\\sqrt[3]{'+mA",
        latexR1:"'}'",
...
nrt:{   htmlL1:"radL(2,strg,mA)+mB",  //nth root
        htmlR1:"radR()",
        htmlL2:"radL(2,strg,mA)+mB",
        htmlR2:"radR()",
        texfunc:"\\sqrt[]",
        latexL1:"'\\\\sqrt['+mA+']{'+mB",
        latexR1:"'}'",
...
lgn:{   htmlL1:"'<Xfnc>log<sub>'+mA+'</sub><Xfnx>('+mB", //nth log
        htmlR1:"')'",
        htmlL2:"'<Xfnc>log<sub>'+mA+'</sub> '+mB",
        htmlR2:"' <Xfxp>'",
        texfunc:"\\log_",
        latexL1:"'\\\\log_{'+mA+'}(<Xfnx>'+mB",
        latexR1:"')'",
        latexL2:"'\\\\log_{'+mA+'}{'+mB",
        latexR2:"'}<Xfxp>'",
        mg: "'lgn('+mA+','+mB+')'",
        },
log:{   htmlL1:"'<Xfnc>log<Xfnx>('+mA", //natural log
        htmlR1:"')'",
        htmlL2:"'<Xfnc>log '+mA",
        htmlR2:"' <Xfxp>'",
        texfunc:"\\log",
...
lne:{   htmlL1:"'<Xfnc>ln<Xfnx>('+mA", //natural log
        htmlR1:"')'",
        htmlL2:"'<Xfnc>ln '+mA",
        htmlR2:"' <Xfxp>'",
        texfunc:"\\ln",
...
int:{   htmlL1:"brkt('&#8970;',strg)+mA", //integer component
        htmlR1:"brkt('&#8971;',strg)", 
        htmlL2:"brkt('&#8970;',strg)+mA",
        htmlR2:"brkt('&#8971;',strg)",
        texfunc:"\\lfloor",
        latexL1:"'\\\\left\\\\lfloor '+mA",
        latexR1:"'\\\\right\\\\rfloor '",
        latexL2:"'\\\\left\\\\lfloor '+mA",
        latexR2:"'\\\\right\\\\rfloor '",
        mg: "'int('+mA+')'",
        },
cei:{   htmlL1:"brkt('&#8968;',strg)+mA",  //ceiling
        htmlR1:"brkt('&#8969;',strg)",
        htmlL2:"brkt('&#8968;',strg)+mA",
        htmlR2:"brkt('&#8969;',strg)",
        texfunc:"\\XXX",
        latexL1:"'\\\\left\\\\lceil '+mA",
        latexR1:"'\\\\right\\\\rceil '",
        latexL2:"'\\\\left\\\\lceil '+mA",
        latexR2:"'\\\\right\\\\rceil '",
        mg: "'cei('+mA+')'",
        },
abs:{   htmlL1:"brkt('&#124;',strg)+mA", //absolute value
        htmlR1:"brkt('&#124;',strg)",
        htmlL2:"brkt('&#124;',strg)+mA",
        htmlR2:"brkt('&#124;',strg)",
        texfunc:"\\|",
...
erf:{   htmlL1:"'<Xfnc>erf<Xfnx>('+mA", //error function
        htmlR1:"')'",
        htmlL2:"'<Xfnc>erf<Xfnx>('+mA",
        htmlR2:"')<Xfxp>'",
        texfunc:"\\erf",
        latexL1:"'\\\\erf('+mA",
        latexR1:"')'",
...
efc:{   htmlL1:"'<Xfnc>erfc<Xfnx>('+mA",  //inverse error function
        htmlR1:"')'",
        htmlL2:"'<Xfnc>erfc<Xfnx>('+mA",
        htmlR2:"')'",
        texfunc:"\\erfc",
        latexL1:"'\\\\erfc('+mA",
        latexR1:"')'",
...
arg:{   htmlL1:"'<Xfnc>arg<Xfnx>('+mA",  //arg
        htmlR1:"')'",
        htmlL2:"'<Xfnc>arg<Xfnx>('+mA",
        htmlR2:"')<Xfxp>'",
        texfunc:"\\arg",
        latexL1:"'\\\\arg(<Xfnx>'+mA",
        latexR1:"')'",
...
exp:{   htmlL1:"'<Xfnc>exp<Xfnx>('+mA", //e^x
        htmlR1:"')'",
        htmlL2:"'<Xfnc>exp<Xfnx>('+mA",
        htmlR2:"')<Xfxp>'",
        texfunc:"\\exp",
        latexL1:"'\\\\exp(<Xfnx>'+mA",
        latexR1:"')'",
...
gam:{   htmlL1:"'<Xfnc>&#915;<Xfnx>('+mA",  //gamma
        htmlR1:"')'",
        htmlL2:"'<Xfnc>&#915;<Xfnx>('+mA",
        htmlR2:"')'",
        texfunc:"\\XXX",
        latexL1:"'\\\\Gamma(<Xfnx>'+mA",
        latexR1:"')'",
        latexL2:"'\\\\Gamma(<Xfnx>'+mA",
        latexR2:"')'",
        mg: "'gam('+mA+')'",
        },
cdf:{   htmlL1:"'<Xfnc>&#934;<Xfnx>('+mA",  //cumulative density function
        htmlR1:"')'",
        htmlL2:"'<Xfnc>&#934;<Xfnx>('+mA",
        htmlR2:"')'",
        texfunc:"\\XXX",
        latexL1:"'\\\\Phi(<Xfnx>'+mA",
        latexR1:"')'",
...
pdf:{   htmlL1:"'<Xfnc>&#966;<Xfnx>('+mA",  //probability density function
        htmlR1:"')'",
        htmlL2:"'<Xfnc>&#966;<Xfnx>('+mA",
        htmlR2:"')'",
        texfunc:"\\XXX",
...
lcf:{   htmlL1:"'<Xfnc>&#934;<sub><i>ln</i></sub><Xfnx>('+mA", //log cumulative density function
        htmlR1:"')'",
        htmlL2:"'<Xfnc>&#934;<sub><i>ln</i></sub><Xfnx>('+mA",
        htmlR2:"')'",
        texfunc:"\\XXX",
        latexL1:"'\\\\Phi_ln(<Xfnx>'+mA",
        latexR1:"')'",
        latexL2:"'\\\\Phi_ln(<Xfnx>'+mA",
        latexR2:"')'",
        mg: "'lcf('+mA+')'",
        },
lpf:{   htmlL1:"'<Xfnc>&#966;<sub><i>ln</i></sub><Xfnx>('+mA", //log probability density function
        htmlR1:"')'",
        htmlL2:"'<Xfnc>&#966;<sub><i>ln</i></sub><Xfnx>('+mA",
        htmlR2:"')'",
        texfunc:"\\XXX",
...
rou:{   htmlL1:"'<Xfnc>rou<Xfnx>('+mA",  //round to nearest int
        htmlR1:"')'",
        htmlL2:"'<Xfnc>rou<Xfnx>('+mA",
        htmlR2:"')'",
        texfunc:"\\XXX",
        latexL1:"'\\\\rou(<Xfnx>'+mA",
        latexR1:"')'",
...
rnd:{   htmlL1:"'<Xfnc>rnd<Xfnx>('+mA",  //random number
        htmlR1:"')'",
        htmlL2:"'<Xfnc>rnd<Xfnx>('+mA",
        htmlR2:"')'",
        texfunc:"\\XXX",
        latexL1:"'\\\\rnd(<Xfnx>'+mA",
        latexR1:"')'",
...
rex:{   htmlL1:"'<Xfnc>Re<Xfnx>('+mA",  //real component
        htmlR1:"')'",
        htmlL2:"'<Xfnc>Re<Xfnx>('+mA",
        htmlR2:"')'",
        texfunc:"\\XXX",
        latexL1:"'\\\\Re(<Xfnx>'+mA",
        latexR1:"')'",
...
imx:{   htmlL1:"'<Xfnc>Im<Xfnx>('+mA",  //imaginary component
        htmlR1:"')'",
        htmlL2:"'<Xfnc>Im<Xfnx>('+mA",
        htmlR2:"')'",
        texfunc:"\\XXX",
        latexL1:"'\\\\Im(<Xfnx>'+mA",
        latexR1:"')'",
...
frc:{   htmlL1:"'<Xfnc>frac<Xfnx>('+mA",  //decimal component
        htmlR1:"')'",
        htmlL2:"'<Xfnc>frac<Xfnx>('+mA",
        htmlR2:"')'",
        texfunc:"\\XXX",
        latexL1:"'\\\\frc(<Xfnx>'+mA",
        latexR1:"')'",
...
sbr:{   htmlL1:"brkt('&#91;',strg)+mA",  //straight bracket
        htmlR1:"brkt('&#93;',strg)",
        htmlL2:"brkt('&#91;',strg)+mA",
        htmlR2:"brkt('&#93;',strg)",
        texfunc:"\\XXX",
...
cbr:{   htmlL1:"brkt('&#123;',strg)+mA",  //curly bracket
        htmlR1:"brkt('&#125;',strg)",
        htmlL2:"brkt('&#123;',strg)+mA",
        htmlR2:"brkt('&#125;',strg)",
        texfunc:"\\XXX",
...
und:{   htmlL1:"undL()+mA",
        ...
        htmlR2:"'</span>'",
        texfunc:"\\underline",
        latexL1:"'\\\\underline{'+mA",
        latexR1:"'}'",
        latexL2:"'\\\\underline{'+mA",
        latexR2:"'}'",
        mg: "'und('+mA+')'",
        },
udt:{   htmlL1:"udtL()+mA", //over dot
        htmlR1:"udtR()",
        htmlL2:"udtL()+mA",
        htmlR2:"udtR()",
        texfunc:"\\dot",
...
dif:{   htmlL1:"'<i>d</i>'+mA",  //differential
        htmlR1:"''",
        htmlL2:"'<i>d</i>'+mA",
        htmlR2:"''",
        texfunc:"\\XXX",
...
det:{   htmlL1:"'det'+mA",  //matrix determinant
        htmlR1:"''",
        htmlL2:"'det'+mA",
        htmlR2:"''",
        texfunc:"\\det",
...
function dFunc(dXpr, prefix) { //map FUNC format to export format
    ...
    for (var nXf=0;nXf<sCount;nXf++) {
        ...
        if (mgConfig.fnFmt == "fn x" && iXf < lSym && funcselect(funcKey,fnformatR).indexOf(" ") > -1 && paramS[0].replace(/[\|\(\{](.*)[\|\)\}]/g,"").search(/[+(&minus;)]/) > -1 ) {paramS[0] = "("+paramS[0]+")"} //add parens to inside (fn x) functions
        if (iXf < lSym && prefix != "mg") {rTmp = rFunc(payload,paramS)} //enable right side function if parens match
        dXpr = dXpr.substr(0,bSym-(funcKey.length+1))+lFunc(payload,paramS)+rTmp+dXpr.substr(iXf+1,lSym); //assemble output
    }
    return dXpr
}
